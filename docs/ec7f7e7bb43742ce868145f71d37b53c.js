...
const navigationBarHeight = app.statusBarHeight + 44 + 'px'; //数据页数
...
Page({
  ...
  onPullDownRefresh: function () {
    let that = this;
    wx.request({
      url: 'https://fengcao.tuchong.com/rest/2/sites/' + that.data.siteId + '/posts?count=20&page=1&before_timestamp=0',
      //获取作者所有图文作品数据
      data: {
        x: '',
        y: ''
  ...
  onReachBottom: function () {
    ...
    let that = this;
    wx.request({
      url: 'https://fengcao.tuchong.com/rest/2/sites/' + that.data.siteId + '/posts?count=20&page=' + page + '&before_timestamp=0',
      //获取作者所有图文作品数据
      data: {
        x: '',
        y: ''
